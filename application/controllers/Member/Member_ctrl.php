...
class Member_ctrl extends CI_Controller
{
	...
	{
		$dataa = array(
			'title'  => 'GoSurvey/Dashboard - Member',
			'user' => $this->db->get_where('tbl_user', ['email_usr' => $this->session->userdata('email')])->row_array()
		);

		// $data['title'] = 'GoSurvey/Dashboard - Member';

		$data['profil'] = $this->db->get_where('tbl_profil', ['id_usr' => $dataa['user']['id_usr']])->row_array();
		...
		$this->load->view('Member/UI/Dashboard', $data);
